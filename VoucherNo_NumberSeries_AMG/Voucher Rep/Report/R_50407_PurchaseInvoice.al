report 50407 "PurchaseInvoice_AMG"
{
    // version NAVW110.0

    DefaultLayout = RDLC;
    RDLCLayout = './Reports-rdlc-files/PurchaseInvoice_AMG.rdl';
    Caption = 'Purchase Invoice AMG';
    ...
    dataset
    {
        dataitem("Purch. Inv. Header"; "Purch. Inv. Header")
        {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                    {
                        ...
                        begin
                            ...
                            CheckRep.FormatNoText(NoText, ABS(TotalAmountInclVAT), "Purch. Inv. Header"."Currency Code");
                            IF "Purch. Inv. Header"."Currency Code" <> '' THEN
                                AmtWord2 := "Purch. Inv. Header"."Currency Code" + ' ' + NoText[1]
                            ELSE
            ...
            dataitem(PurchComments; "Purch. Comment Line")
            {
                DataItemTableView = Sorting("No.");
                DataItemLinkReference = "Purch. Inv. Header";
            ...
            begin
                ...
                IF PurchCommentLine.FindFirst() THEN
                    REPEAT
                        if Narration = '' then
                            Narration := PurchCommentLine.Comment
                        else
                            Narration += PurchCommentLine.Comment;
    ...
    var
        Text004: TextConst Comment = '%1 = Document No.', ENU = 'Purchase - Invoice %1';
        ...
        Text010: TextConst Comment = '%1 = Document No.', ENU = 'Purchase - Prepayment Invoice %1';
        OutputNo: Integer;
