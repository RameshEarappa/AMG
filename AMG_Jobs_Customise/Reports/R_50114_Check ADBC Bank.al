report 50114 Check_ADCB
{
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; Integer)
            {
                ...
                var
                //RecordRestrictionMgt: Codeunit "Production Journal Mgt";
                begin
                    IF NOT TestPrint THEN BEGIN
                        ...
                        END ELSE BEGIN
                            IF GenJnlLine2.FIND('-') THEN BEGIN
                                ...
                                REPEAT
                                    ...
                                    // LT_30Jan20_Comment
                                    //LT_30Jan20_New Code
                                    CheckRecordHasUsageRestrictions(GenJnlLine2);
                                    //LT_30Jan20_New Code
    ...
    var
        ...
        RestrictedTxt: Label 'You cannot use %1 for this action.', Comment = 'You cannot use Customer 10000 for this action.';
