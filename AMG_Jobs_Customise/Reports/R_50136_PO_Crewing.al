report 50136 "PO_Crewing"
{
    DefaultLayout = RDLC;
    //RDLCLayout = '50101_28_V2.rdl';
    Caption = 'Purchase Order Crewing';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Om_Signatuer; SigRec.image) { }
            column(H_Signatuer; HSigRec.image) { }
            ...
            begin
                ...
                If Status = Status::Released then begin
                    if SigRec.Get('CLIVE') then
                        SigRec.CalcFields(image);
                    if HSigRec.GET('USMAN') then
                        HSigRec.CalcFields(image);
                End;
