report 60116 "Aged Accounts Payable Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AgedAccountsPayable.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Payable - Custom';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(GrandTotalVLE14RemAmtLCY; GrandTotalVLERemaingAmtLCY[14])
            {
                AutoFormatType = 1;
            }
            column(GrandTotalVLE13RemAmtLCY; GrandTotalVLERemaingAmtLCY[13])
            {
                AutoFormatType = 1;
            }
            column(GrandTotalVLE12RemAmtLCY; GrandTotalVLERemaingAmtLCY[12])
            {
                AutoFormatType = 1;
            }
            column(GrandTotalVLE11RemAmtLCY; GrandTotalVLERemaingAmtLCY[11])
            {
                AutoFormatType = 1;
            }
            ...
            dataitem(CurrencyLoop; "Integer")
            {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    column(AgedVendLedgEnt11RemAmtLCY; AgedVendorLedgEntry[11]."Remaining Amt. (LCY)")
                    {
                        AutoFormatType = 1;
                    }
                    column(AgedVendLedgEnt12RemAmtLCY; AgedVendorLedgEntry[12]."Remaining Amt. (LCY)")
                    {
                        AutoFormatType = 1;
                    }
                    column(AgedVendLedgEnt13RemAmtLCY; AgedVendorLedgEntry[13]."Remaining Amt. (LCY)")
                    {
                        AutoFormatType = 1;
                    }
                    column(AgedVendLedgEnt14RemAmtLCY; AgedVendorLedgEntry[14]."Remaining Amt. (LCY)")
                    {
                        AutoFormatType = 1;
                    }
                    ...
                    column(AgedVendLedgEnt14RemAmt; AgedVendorLedgEntry[14]."Remaining Amount")
                    {
                        AutoFormatExpression = CurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(AgedVendLedgEnt13RemAmt; AgedVendorLedgEntry[13]."Remaining Amount")
                    {
                        AutoFormatExpression = CurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(AgedVendLedgEnt12RemAmt; AgedVendorLedgEntry[12]."Remaining Amount")
                    {
                        AutoFormatExpression = CurrencyCode;
                        AutoFormatType = 1;
                    }
                    column(AgedVendLedgEnt11RemAmt; AgedVendorLedgEntry[11]."Remaining Amount")
                    {
                        AutoFormatExpression = CurrencyCode;
                        AutoFormatType = 1;
                    }
        ...
        dataitem(CurrencyTotals; "Integer")
        {
            ...
            column(AgedVendLedgEnt11RemAmtLCY11; AgedVendorLedgEntry[11]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
            column(AgedVendLedgEnt12RemAmtLCY12; AgedVendorLedgEntry[12]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
            column(AgedVendLedgEnt13RemAmtLCY13; AgedVendorLedgEntry[13]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
            column(AgedVendLedgEnt14RemAmtLCY14; AgedVendorLedgEntry[14]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
            column(AgedVendLedgEnt15RemAmtLCY15; AgedVendorLedgEntry[15]."Remaining Amount")
            {
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
    ...
    var
        ...
        TotalVendorLedgEntry: array[14] of Record "Vendor Ledger Entry";
        AgedVendorLedgEntry: array[15] of Record "Vendor Ledger Entry";
        TempCurrency: Record Currency temporary;
        TempCurrency2: Record Currency temporary;
        TempCurrencyAmount: Record "Currency Amount" temporary;
        DetailedVendorLedgerEntry: Record "Detailed Vendor Ledg. Entry";
        TypeHelper: Codeunit "Type Helper";
        GrandTotalVLERemaingAmtLCY: array[14] of Decimal;
    ...
    begin
        ...
        //28.10.2020
        if HeadingType = HeadingType::"Date Interval" then
            HeaderText[11] := StrSubstNo('%1\%2', Text001, PeriodStartDate[10])
        else
            HeaderText[11] := StrSubstNo('%1\%2 %3', Text003, EndingDate - PeriodStartDate[10] + 2, Text002);
        //28.10.2020
