report 50130 "PO_HR&Admin"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(Hr_Signature; SigRec.image) { }
            ...
            begin
                ...
                /*
                AppEnry.Reset();
                AppEnry.SetRange("Document No.", "No.");
                AppEnry.SetRange("Approver ID", 'FAZIDAH');
                If AppEnry.FindLast() then begin
                    If AppEnry.Status = AppEnry.Status::Approved then begin
                        If SigRec.get('FAZIDAH') then;
