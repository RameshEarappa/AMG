report 50134 "PosSalCrMemo"
{
        ...
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            dataitem("Sales Cr.Memo Line"; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    Clear(TotAmtIncVat);
                    SalInvRec2.Reset();
                    SalInvRec2.SetRange("Document No.", "Sales Cr.Memo Line"."Document No.");
                    ...
                    if "Sales Cr.Memo Header"."Currency Factor" <> 0 then
                        LocalCurr := TotAmtIncVat * (1 / "Sales Cr.Memo Header"."Currency Factor")
                    else
                        LocalCurr := TotalAmt;
                    ...
                    if ("Sales Cr.Memo Line".Type <> "Sales Cr.Memo Line".Type::" ") then begin
                        SL_No += 1;
                        if SL_No <> 1 then
                            Type1 := true
                        else
    ...
    var
        ...
        SubTotal5: Decimal;
        TotSubTotal: Decimal;
        SalInvRec2: Record "Sales Cr.Memo Line";
        TaxAmt: Decimal;
        FinalTotAmt: Decimal;
