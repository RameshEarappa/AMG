report 50131 "Draft_Sales Invoice MLS"
{
    DefaultLayout = RDLC;
    //RDLCLayout = '50101_28_V2.rdl';
    Caption = 'Sales Invoice Invoice';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    //CheckRep.FormatNoText(NoText, Amt_Tot_Word, '');
                    ConvertAmountInWord.FormatNoText(NoText, Amt_Tot_Word, CurrCode);
