report 50132 "Draft_SalInvExcWitholdingTax"
{

    DefaultLayout = RDLC;
    //RDLCLayout = '50101_28_V2.rdl';
    Caption = 'Sales Excluding Withholding Tax';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    LineRec2.SetFilter(Quantity, '<>%1', 0);
                    ...
                    //CheckRep.FormatNoText(NoText, ResultTot * DivQty, '');
                    ConvertAmountInWord.FormatNoText(NoText, ResultTot * DivQty, CurrCode);
            ...
            trigger OnAfterGetRecord();
            begin
                If ("Ship-to Code" <> '') or ("Ship-to Name" <> ' ') then begin
    ...
    var
        ...
        ConvertAmountInWord: Codeunit "Amount In Word LT";
