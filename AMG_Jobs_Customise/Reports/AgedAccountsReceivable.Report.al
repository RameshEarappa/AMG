report 60125 "Aged Accounts ReceivableReport"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AgedAccountsReceivable.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Receivable - Custom';
    ...
    dataset
    {
        dataitem(Header; "Integer")
        {
            ...
            column(HeaderText14; HeaderText[14])
            {
            }
            column(HeaderText13; HeaderText[13])
            {
            }
            ...
            column(GrandTotalCLE14RemAmt; GrandTotalCustLedgEntry[14]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            column(GrandTotalCLE13RemAmt; GrandTotalCustLedgEntry[13]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            column(GrandTotalCLE12RemAmt; GrandTotalCustLedgEntry[12]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            column(GrandTotalCLE11RemAmt; GrandTotalCustLedgEntry[11]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            ...
            column(GrandTotalCLE11CustRemAmtLCY; Pct(GrandTotalCustLedgEntry[11]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            column(GrandTotalCLE12CustRemAmtLCY; Pct(GrandTotalCustLedgEntry[12]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            column(GrandTotalCLE13CustRemAmtLCY; Pct(GrandTotalCustLedgEntry[13]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            column(GrandTotalCLE14CustRemAmtLCY; Pct(GrandTotalCustLedgEntry[14]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            ...
            column(GrandTotalCLE14PctRemAmtLCY; Pct(GrandTotalCustLedgEntry[14]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            column(GrandTotalCLE13PctRemAmtLCY; Pct(GrandTotalCustLedgEntry[13]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            column(GrandTotalCLE12PctRemAmtLCY; Pct(GrandTotalCustLedgEntry[12]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            column(GrandTotalCLE11PctRemAmtLCY; Pct(GrandTotalCustLedgEntry[11]."Remaining Amt. (LCY)", GrandTotalCustLedgEntry[1]."Amount (LCY)"))
            {
            }
            ...
            column(GrandTotalCLE14RemAmtLCY; GrandTotalCustLedgEntry[14]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            column(GrandTotalCLE13RemAmtLCY; GrandTotalCustLedgEntry[13]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            column(GrandTotalCLE12RemAmtLCY; GrandTotalCustLedgEntry[12]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            column(GrandTotalCLE11RemAmtLCY; GrandTotalCustLedgEntry[11]."Remaining Amt. (LCY)")
            {
                AutoFormatType = 1;
            }
            ...
            dataitem(Customer; Customer)
            {
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(TempCustLedgEntryLoop; "Integer")
                    {
                        ...
                        column(AgedCLE11RemAmtLCY; AgedCustLedgEntry[11]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(AgedCLE12RemAmtLCY; AgedCustLedgEntry[12]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(AgedCLE13RemAmtLCY; AgedCustLedgEntry[13]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(AgedCLE14RemAmtLCY; AgedCustLedgEntry[14]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        column(AgedCLE14TempRemAmt; AgedCustLedgEntry[14]."Remaining Amount")
                        {
                            AutoFormatExpression = CurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(AgedCLE13TempRemAmt; AgedCustLedgEntry[13]."Remaining Amount")
                        {
                            AutoFormatExpression = CurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(AgedCLE12TempRemAmt; AgedCustLedgEntry[12]."Remaining Amount")
                        {
                            AutoFormatExpression = CurrencyCode;
                            AutoFormatType = 1;
                        }
                        column(AgedCLE11TempRemAmt; AgedCustLedgEntry[11]."Remaining Amount")
                        {
                            AutoFormatExpression = CurrencyCode;
                            AutoFormatType = 1;
                        }
                        ...
                        column(TotalCLE11RemAmtLCY; TotalCustLedgEntry[11]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(TotalCLE12RemAmtLCY; TotalCustLedgEntry[12]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(TotalCLE13RemAmtLCY; TotalCustLedgEntry[13]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        column(TotalCLE14RemAmtLCY; TotalCustLedgEntry[14]."Remaining Amt. (LCY)")
                        {
                            AutoFormatType = 1;
                        }
                        ...
                        column(TotalCLE14RemAmt; TotalCustLedgEntry[14]."Remaining Amount")
                        {
                            AutoFormatType = 1;
                        }
                        column(TotalCLE13RemAmt; TotalCustLedgEntry[13]."Remaining Amount")
                        {
                            AutoFormatType = 1;
                        }
                        column(TotalCLE12RemAmt; TotalCustLedgEntry[12]."Remaining Amount")
                        {
                            AutoFormatType = 1;
                        }
                        column(TotalCLE11RemAmt; TotalCustLedgEntry[11]."Remaining Amount")
                        {
                            AutoFormatType = 1;
                        }
            ...
            dataitem(CurrencyTotals; "Integer")
            {
                ...
                column(AgedCLE15RemAmt; AgedCustLedgEntry[15]."Remaining Amount")
                {
                    AutoFormatExpression = CurrencyCode;
                    AutoFormatType = 1;
                }
                column(AgedCLE14RemAmt; AgedCustLedgEntry[14]."Remaining Amount")
                {
                    AutoFormatExpression = CurrencyCode;
                    AutoFormatType = 1;
                }
                column(AgedCLE13RemAmt; AgedCustLedgEntry[13]."Remaining Amount")
                {
                    AutoFormatExpression = CurrencyCode;
                    AutoFormatType = 1;
                }
                column(AgedCLE12RemAmt; AgedCustLedgEntry[12]."Remaining Amount")
                {
                    AutoFormatExpression = CurrencyCode;
                    AutoFormatType = 1;
                }
                column(AgedCLE11RemAmt; AgedCustLedgEntry[11]."Remaining Amount")
                {
                    AutoFormatExpression = CurrencyCode;
                    AutoFormatType = 1;
                }
    ...
    var
        ...
        TotalCustLedgEntry: array[14] of Record "Cust. Ledger Entry";
        GrandTotalCustLedgEntry: array[14] of Record "Cust. Ledger Entry";
        AgedCustLedgEntry: array[15] of Record "Cust. Ledger Entry";
        ...
        PeriodEndDate: array[14] of Date;
        HeaderText: array[14] of Text[30];
