report 50135 "Draft_Cr_memo Invoice"
{
    DefaultLayout = RDLC;
    //RDLCLayout = '50101_28_V2.rdl';
    Caption = 'Draft Cr. Memo';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(Bank_Account; "Banck Account") { }
            ...
            column(Pre_Assigned_No_; Pre_Assigned_No_) { }
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    Clear(TotAmtIncVat);
                    SalInvRec2.Reset();
                    SalInvRec2.SetRange("Document No.", "Sales Line"."Document No.");
                    ...
                    if "Sales Header"."Currency Factor" <> 0 then
                        LocalCurr := TotAmtIncVat * (1 / "Sales Header"."Currency Factor")
                    else
                        LocalCurr := TotalAmt;
                    Amt_Tot_Word += AMT_IncVat;
                    //Message('%1', TotAmtIncVat);
                    CheckRep.FormatNoText(NoText, Amt_Tot_Word, CurrCode);
            ...
            begin
                If ("Ship-to Code" = '') then begin
                    ...
                    Ship_toRec.Reset();
                    Ship_toRec.SetRange(Code, "Ship-to Code");
                    if Ship_toRec.FindFirst() then;
                    Cust_Name := Ship_toRec.Name;
                    CustAdd := Ship_toRec.Address;
                    CustAdd2 := Ship_toRec."Address 2";
                    Cust_City := Ship_toRec.City;
                    Cust_PoCod := Ship_toRec."Post Code";
                    Cust_Country_Region_Code := Ship_toRec."Country/Region Code";
                    CustContact := Ship_toRec.Contact;
                ...
                if BankAccRec.Get("Banck Account") then begin
    ...
    var
        ...
        Pre_Assigned_No_: Integer;
        Cust_Name: text;
        Ship_toRec: Record "Ship-to Address";
