codeunit 50150 "Amount In Word LT"
{
    trigger OnRun()
    begin
        //InitTextVariable;
            ...
            FOR Exponent := 4 DOWNTO 1 DO BEGIN
                ...
                IF CurrencyCode <> '' then BEGIN
                    ...
                    IF RecCurr.GET(CurrencyCode) THEN
                        DecimalDesc := RecCurr."Subsidary Currency";
                END else
                    DecimalDesc := 'FILS';
...
tableextension 50251 CurrencyExt extends Currency
{
    fields
    {
...
pageextension 50251 Currency extends "Currency Card"
{
    layout
    {
        addafter(Description)
        {
            field("Subsidary Currency"; Rec."Subsidary Currency")
            {
                ApplicationArea = All;
            }
        }
